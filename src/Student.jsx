...
import  web  from "../src/images/request.png";
...
const tiers = [
  {
    ...
    image: web,
    link: "./Request",
    description: ['Request Leave approval from mentor'],
    buttonText: 'Request',
  ...
  },
  {
   ...
   link:"./View",
    description: [
      'View Status of your Leave Requests',
  ...
  },
  {
   ...
   link: "./Delete",
    description: [
      'Withdraw/Delete your Leave Requests',
      ...
      <Container maxWidth="md" component="main">
        <Grid container spacing={5} alignItems="flex-end">
          {tiers.map((tier) => (
            ...
            <Grid item key={tier.title} xs={12} sm={tier.title === 'Delete Requests' ? 12 : 6} md={4}>
              <Card>
                <CardHeader
                  title={tier.title}
                ...
                <CardContent>
                  ...
                  <img src={tier.image} className="img-fluid animated"></img>
                  </div>
                  <ul>
